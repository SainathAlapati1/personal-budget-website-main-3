...
import {
  ...
  ɵɵinvalidFactory,
  ɵɵtext
} from "./chunk-37ZJ3VRY.mjs";

// src/app/app-routing.module.ts
var routes = [
  {
    path: "",
    loadChildren: () => import("./chunk-WRW4WPQK.mjs").then((m) => m.BudgetPlannerModule)
  },
  {
    path: "login",
...
var _AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const moduleImpl = this.moduleImpl ?? import("./chunk-QJRRCVNV.mjs");
...
@angular/platform-browser/fesm2022/animations/async.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-HEKQ2WLQ.mjs.map
