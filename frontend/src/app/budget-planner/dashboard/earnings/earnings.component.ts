...
export class EarningsComponent {
  ...
  onSubmit() {
    ...
    this.dataService
      .insertEarningsData(this.loggedInUser, this.addEarnings.value)
      .subscribe(
        (response) => {
  ...
  updateEarningsData() {
    this.dataService
      .updateEarningsData(this.loggedInUser, this.newEarnings)
      .subscribe(
  ...
  deleteItemI() {
    this.dataService
      .deleteEarningsData(this.loggedInUser, this.newEarnings)
      .subscribe(
        (response) => this.getEarningsData(),
        (error) => {
          console.log('Error: ' + error);
